  ...
  <div class="max-w-screen-lg mx-auto">
    <grid-view title="Footage">
      ...
      <footage-preview-card
        label="With activity"
        to="/footage/activity"
        subtext="captured so far this month"
      ...
      <footage-preview-card
        ...
        to="/footage/normal"
        subtext="captured so far this month*"
        :footage-count="normalFootageCount"
      />
    ...
    >
      <div class="flex flex-wrap sm:flex-nowrap justify-between w-full">
        <p class="my-auto">
          *Videos without motion are kept for
          {{ daysKeepingMotionlessVideos }} days
        </p>
...
export default {
  ...
  async asyncData() {
    ...
    const [normalFootageCount, activeFootageCount, config] = await Promise.all(
      tasks
    ).catch((err) => {
