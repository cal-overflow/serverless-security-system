    ...
    <div class="max-w-screen-lg mx-auto">
      <div class="bg-card-light dark:bg-card-dark m-0 md:m-6 p-4 shadow-lg dark:shadow-shadow-dark hover:shadow-none hover:rounded motion-safe:animate-fade-in-fast transition">
        <p class="text-4xl font-bold text-center md:text-left">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="inline text-primary-light dark:text-primary-dark w-24 md:w-16 h-auto">
      ...
      <div id="error-main-info-card" class="bg-card-light dark:bg-card-dark m-0 md:m-6 p-4 shadow-lg dark:shadow-shadow-dark hover:shadow-none hover:rounded motion-safe:animate-fade-in-fast transition">
      ...
      <div id="error-more-info-card" class="bg-card-light dark:bg-card-dark m-0 md:m-6 pt-12 p-6 md:p-4 flex-wrap shadow-lg hover:shadow-none hover:rounded motion-safe:animate-fade-in transition">
        <div>
